...
SECRET_KEY = 'django-insecure-wrhkmfonj@w$0!6zn2%a%6n+z*69a+bssz=^z(+%&jr3uit1yl'
...
ROOT_URLCONF = 'alzheimer_project.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'alzheimer_project/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
