...
from api.views import ActivityByUserView, ActivityByUserDateView, GetMusicsAPI, GetMusicAPI, FeelingUserView, ChatbotView, ContactView
...
urlpatterns = [
    ...
    # Contact
    path("contact/", ContactView.as_view({'get':'list'})),
