...
from api.views import ActivityByUserView, ActivityByUserDateView, GetMusicsAPI, GetMusicAPI, FeelingUser
...
urlpatterns = [
    ...
    path("feeling/<int:id>", FeelingUser.as_view({'get':'list', 'post':'create'})),
